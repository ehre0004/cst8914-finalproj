...
function openModal(event) {
    ...
    modalDescription.textContent = 'We get "aha!" moments from product managers who try our services for the first time. We have hosted lab days, workshops, and usability testing services for organizations like:';

    const orgList = document.createElement('ul');
    const orgs = ['McGill University', 'Walmart.ca', 'Apple.ca', 'Google.ca', 'Government of Canada'];
